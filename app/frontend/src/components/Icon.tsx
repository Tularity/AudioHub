...
const ICONS = {
  ...
  // 「改这个名字」。`tagname` 那枚标签形语义偏「打标签」，而这里的动作是编辑——
  // 详情头上那枚按钮没有文字标签，图标就是它唯一说得出的话。
  pencil: '<path d="M4 20h4L19.5 8.5a2.1 2.1 0 0 0-3-3L5 17v3z"/><path d="M14.5 6.5l3 3"/>',
  // 「断开这条配对」。在 `pair` 那枚链形的基础上把中段断开并加两道断裂线——
  // 通用的警示三角只说「危险」，说不出危险的是什么，而这一块目前只有解除配对
  // 一个动作。
  unlink: '<path d="M10.5 6.5L12 5a4 4 0 0 1 5.7 5.7l-1.5 1.5"/><path d="M13.5 17.5L12 19a4 4 0 0 1-5.7-5.7l1.5-1.5"/><path d="M4 4l3 3M20 20l-3-3"/>',
