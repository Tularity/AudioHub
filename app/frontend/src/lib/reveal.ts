 ...
 *
 * Match the monotonic entrance curve used by the other surfaces, preserving
 * the pressed point and full-viewport coverage without a prolonged linear wipe.
 */
export const REVEAL_EASING = 'cubic-bezier(.16, 1, .3, 1)';
