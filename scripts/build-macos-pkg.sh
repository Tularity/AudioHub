...
# Let Installer draw its native appearance. An opaque dark bitmap shared by
# Aqua and Dark Aqua obscures the native light background without changing
# the system's label and content colors.
